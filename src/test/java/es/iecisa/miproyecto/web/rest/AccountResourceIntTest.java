package es.iecisa.miproyecto.web.rest;

import es.iecisa.miproyecto.config.Constants;
import es.iecisa.miproyecto.EjemploJHipsterOnlineApp;
import es.iecisa.miproyecto.domain.Authority;
import es.iecisa.miproyecto.domain.PersistentToken;
import es.iecisa.miproyecto.domain.User;
import es.iecisa.miproyecto.repository.AuthorityRepository;
import es.iecisa.miproyecto.repository.PersistentTokenRepository;
import es.iecisa.miproyecto.repository.UserRepository;
import es.iecisa.miproyecto.security.AuthoritiesConstants;
import es.iecisa.miproyecto.service.MailService;
import es.iecisa.miproyecto.service.dto.UserDTO;
import es.iecisa.miproyecto.web.rest.errors.ExceptionTranslator;
import es.iecisa.miproyecto.web.rest.vm.KeyAndPasswordVM;
import es.iecisa.miproyecto.web.rest.vm.ManagedUserVM;
import es.iecisa.miproyecto.service.UserService;
...
@SpringBootTest(classes = EjemploJHipsterOnlineApp.class)
